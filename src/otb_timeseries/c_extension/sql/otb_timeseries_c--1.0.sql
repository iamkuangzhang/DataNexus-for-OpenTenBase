...
DROP FUNCTION IF EXISTS time_bucket_gapfill(INTERVAL, TIMESTAMPTZ, TIMESTAMPTZ, TIMESTAMPTZ) CASCADE;
DROP FUNCTION IF EXISTS time_bucket_gapfill(INTERVAL, TIMESTAMP, TIMESTAMP, TIMESTAMP) CASCADE;
DROP FUNCTION IF EXISTS time_bucket_gapfill(INTERVAL, TIMESTAMPTZ, TIMESTAMPTZ) CASCADE;
DROP FUNCTION IF EXISTS time_bucket_gapfill(INTERVAL, TIMESTAMP, TIMESTAMP) CASCADE;
DROP FUNCTION IF EXISTS time_bucket_gapfill(INTERVAL, TIMESTAMPTZ) CASCADE;
DROP FUNCTION IF EXISTS time_bucket_gapfill(INTERVAL, TIMESTAMP) CASCADE;
DROP TYPE IF EXISTS gauge_summary CASCADE;
DROP TYPE IF EXISTS stats_summary CASCADE;
...
-- 删除旧的SQL版本（如果存在）
DROP FUNCTION IF EXISTS time_bucket(INTERVAL, TIMESTAMPTZ, TIMESTAMPTZ) CASCADE;
DROP FUNCTION IF EXISTS time_bucket(INTERVAL, TIMESTAMPTZ) CASCADE;
DROP FUNCTION IF EXISTS time_bucket(INTERVAL, TIMESTAMP, TIMESTAMP) CASCADE;
DROP FUNCTION IF EXISTS time_bucket(INTERVAL, TIMESTAMP) CASCADE;
...
DROP AGGREGATE IF EXISTS otb_ts.first(NUMERIC, TIMESTAMPTZ) CASCADE;
DROP AGGREGATE IF EXISTS otb_ts.last(NUMERIC, TIMESTAMPTZ) CASCADE;
DROP AGGREGATE IF EXISTS otb_ts.first(DOUBLE PRECISION, TIMESTAMPTZ) CASCADE;
DROP AGGREGATE IF EXISTS otb_ts.last(DOUBLE PRECISION, TIMESTAMPTZ) CASCADE;
DROP AGGREGATE IF EXISTS otb_ts.first_numeric(NUMERIC, TIMESTAMP) CASCADE;
DROP AGGREGATE IF EXISTS otb_ts.last_numeric(NUMERIC, TIMESTAMP) CASCADE;
DROP AGGREGATE IF EXISTS otb_ts.first_double(DOUBLE PRECISION, TIMESTAMP) CASCADE;
DROP AGGREGATE IF EXISTS otb_ts.last_double(DOUBLE PRECISION, TIMESTAMP) CASCADE;
